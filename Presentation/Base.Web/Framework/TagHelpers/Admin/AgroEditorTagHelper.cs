...
namespace Base.Web.Framework.TagHelpers.Admin
{
    /// <summary>
    /// "nop-editor" tag helper
    /// </summary>
    [HtmlTargetElement("agro-editor", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class AgroEditorTagHelper : TagHelper
    {
        #region Constants
        ...
        public AgroEditorTagHelper(IHtmlHelper htmlHelper)
        {
