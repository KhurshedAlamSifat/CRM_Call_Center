...
namespace Base.Core.Configuration
{
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, ICrmFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(CrmConfigurationDefaults.AppSettingsFilePath);
