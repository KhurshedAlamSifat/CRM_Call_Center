...
namespace Base.Services.Caching
{
    /// <summary>
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(CrmEntityCacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(CrmEntityCacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(CrmEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
